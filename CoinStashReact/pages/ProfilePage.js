...
class ProfilePage extends Component {
  ...
  getAccounts = () => {
    fetch('https://coinstache-backend.herokuapp.com/coinbases/accounts')
    ...
    fetch('https://coinstache-backend.herokuapp.com/coinbases/usdwallet')
    .then(function(response) {
      return response.json();
    }).then((obj) => {
      let usdN = obj.name
  ...
  fetch('https://coinstache-backend.herokuapp.com/coinbases/ethwallet')
  .then(function(response) {
    return response.json();
  }).then((obj) => {
  ...
  fetch('https://coinstache-backend.herokuapp.com/coinbases/ltcwallet')
  .then(function(response) {
    return response.json();
  }).then((obj) => {
