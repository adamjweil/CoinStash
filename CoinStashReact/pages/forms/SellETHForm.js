...
export default class SellETHForm extends Component {
  constructor() {
    super();
    this.state = {
      session: {
  ...
  handlePress() {
    ...
    let responseJson = fetch ("https://coinstache-backend.herokuapp.com/coinbases/sellETH", {
      method: 'post',
      headers: {
      ...
      <View style={styles.container}>
        <Text style={styles.formTitle}></Text>
          ...
          <View style={styles.inputContainer}>
            <Text style={styles.labelTitle}>Sell from:</Text>
            <SelectInput
        ...
        <View style={styles.twoColumnLayout}>
          <View style={styles.flexDirectionColumn, styles.firstPaymentColumn}>
            <View style={styles.currencyInputContainer}>
              <Text style={styles.currencyPriceLabel}>ETH</Text>
              <TextInput
